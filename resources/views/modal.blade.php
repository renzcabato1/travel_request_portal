...
{{-- cancel request --}}
<div class="modal fade" id="cancel_request{{$pending_request->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
{{-- disapproved request --}}
<div class="modal fade" id="disapprove{{$pending_request->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class='row'>
